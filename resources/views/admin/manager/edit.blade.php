                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form action="{{route('manager.update', $admin->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                @include('admin.components.select', ['label'=>'Роль','name'=>'role_id','items'=>$roles,'title'=>'title','required'=>true,'value'=>$admin->role_id])
